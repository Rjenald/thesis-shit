...
/// Main teacher account page
/// Displays teacher welcome card and access to teaching tools
...
class _TeacherAccountPageState extends State<TeacherAccountPage> {
  // UI Constants
  static const double _headerPadding = 16;
  ...
  /// Load teacher's username from session storage
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTeacherToolsSection(),
                    SizedBox(height: _sectionSpacing),
                    _buildKaraokeDivider(),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            icon: const Icon(Icons.logout, color: Color(0xFFF44336), size: 22),
            onPressed: _logout,
            tooltip: 'Logout',
          ),
        ],
  ...
  /// Greeting card with username and account type badge
  ...
  /// Account type badge (Teacher Account)
  ...
  /// Section with all available teacher tools
  Widget _buildTeacherToolsSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
        ...
        _buildToolCard(
          ...
          subtitle: 'Scale exercises, sustained notes,\nand phrase loop drills',
          color: AppColors.primaryCyan,
          onTap: () => Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const PracticeDrillPage()),
          ),
        ),
        SizedBox(height: _cardSpacing),
        _buildToolCard(
          ...
          title: 'Teacher Mode',
          subtitle: 'Manage classes, assign songs,\nand view student reports',
          color: const Color(0xFF7C4DFF),
          onTap: () => Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const TeacherModePage()),
          ),
        ),
        SizedBox(height: _cardSpacing),
        _buildToolCard(
          ...
          title: 'Piano Mode',
          subtitle: 'Play piano keys, record sequences,\nand have students follow along',
          color: const Color(0xFFFF6D00),
          onTap: () => Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const PianoModePage()),
          ),
        ),
        SizedBox(height: _cardSpacing),
        _buildToolCard(
          ...
          title: 'Live Pitch',
          subtitle: 'Real-time CREPE pitch detection\nwith graph & cents accuracy',
          color: AppColors.primaryCyan,
          onTap: () => Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const TeacherModePage(initialTab: 3)),
          ),
        ),
      ],
    );
  ...
  /// Individual tool card with icon, title, and description
  ...
  /// Divider with "KARAOKE" label
  Widget _buildKaraokeDivider() {
    return Row(
      children: [
        Expanded(
  ...
  /// Button to open Karaoke mode
  Widget _buildKaraokeButton() {
    return GestureDetector(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const HomePage(showBackButton: true)),
      ),
      child: Container(
        width: double.infinity,
        ...
        child: Row(
          children: [
            const Icon(Icons.mic_none_outlined, color: AppColors.grey, size: 26),
            const SizedBox(width: 16),
            const Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  SizedBox(height: 2),
                  Text(
                    'Browse songs and start singing',
                    style: TextStyle(
